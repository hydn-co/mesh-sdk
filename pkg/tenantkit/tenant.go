...
// Returns ErrTenantIDMissing if the value is not found or invalid.
...
// WithStreamPath stores a stream path in the context. This is a small
// compatibility shim used by tests that expect a WithStreamPath helper
// on tenantkit. The stream path is stored under an internal key and can
// be retrieved with StreamPathFromContext.
